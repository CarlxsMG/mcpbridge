---
description: Manage the gateway as version-controlled YAML — the CLI's login, pull, plan and apply commands for GitOps workflows, plus connect for MCP client configs.
---
