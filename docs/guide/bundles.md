---
description: Curate tools from several backends behind one MCP endpoint. How /mcp-custom bundles aggregate REST and MCP servers, and when to prefer them over per-client shards.
---
