---
description: ADR-0002 — why MCP REST Bridge propagates W3C traceparent headers through the proxy pipeline, and how trace context survives the MCP-to-REST hop.
---
