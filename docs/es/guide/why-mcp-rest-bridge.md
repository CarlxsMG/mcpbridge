---
description: Dónde encaja MCP REST Bridge entre los gateways y agregadores MCP — qué hace distinto, para quién es y cuándo otra herramienta es la mejor elección.
---
