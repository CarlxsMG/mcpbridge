  ...
  "trace-a1": [
    {
      ...
      endMs: hours(0.1) + 118,
      statusCode: 1,
      attributes: { "mcp.tool": "github__search_issues", "mcp.tool.is_error": false },
      createdAt: hours(0.1),
    },
  ],
  "trace-b2": [
    {
      ...
      statusCode: 2,
      attributes: { "mcp.tool": "internal-crm__find_account", "mcp.tool.is_error": true },
      createdAt: hours(1.2),
    },
  ],
  "trace-c3": [
    {
      ...
      endMs: hours(3) + 188,
      statusCode: 1,
      attributes: { "mcp.tool": "stripe__create_refund", "mcp.tool.is_error": false },
      createdAt: hours(3),
    },
  ],
};
