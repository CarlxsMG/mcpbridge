...
- **`useEntityForm<E>(options: { reset: () => void; fill?: (entity: E) => void })`** — Generalizes the
  ...
  cycle for both create and edit on the same page (edit-in-place is still fine inline — it's _create_
