...
export const compositeRoutes = Router();

compositeRoutes.get("/composites", (_req: Request, res: Response) => {
  res.status(200).json({ items: listComposites() });
});

compositeRoutes.get("/composites/:name", (req: Request<{ name: string }>, res: Response) => {
...
compositeRoutes.post("/composites", requireSuperAdmin, async (req: Request, res: Response) => {
...
compositeRoutes.patch("/composites/:name", requireSuperAdmin, async (req: Request<{ name: string }>, res: Response) => {
...
compositeRoutes.delete("/composites/:name", requireAdminRole, async (req: Request<{ name: string }>, res: Response) => {
  const { name } = req.params;
