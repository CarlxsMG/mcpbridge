...
catalogRoutes.get("/catalog", (_req: Request, res: Response) => {
...
catalogRoutes.post("/catalog", requireSuperAdmin, (req: Request, res: Response) => {
...
catalogRoutes.patch("/catalog/:id", requireSuperAdmin, (req: Request<{ id: string }>, res: Response) => {
  const { id } = req.params;
...
catalogRoutes.delete("/catalog/:id", requireSuperAdmin, (req: Request<{ id: string }>, res: Response) => {
  const { id } = req.params;
  if (id.startsWith("builtin:")) {
