...
bundleRoutes.get("/bundles", (_req: Request, res: Response) => {
  res.status(200).json({ items: listBundles() });
});

bundleRoutes.get("/bundles/:name", (req: Request<{ name: string }>, res: Response) => {
...
// that design.
bundleRoutes.post("/bundles", requireSuperAdmin, async (req: Request, res: Response) => {
...
bundleRoutes.patch("/bundles/:name", requireSuperAdmin, async (req: Request<{ name: string }>, res: Response) => {
...
bundleRoutes.delete("/bundles/:name", requireAdminRole, async (req: Request<{ name: string }>, res: Response) => {
  const { name } = req.params;
...
bundleRoutes.get("/bundles/:name/install-links", (req: Request<{ name: string }>, res: Response) => {
  const { name } = req.params;
