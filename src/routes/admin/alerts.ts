...
alertRoutes.get("/alerts", requireOperator, (_req: Request, res: Response) => {
...
alertRoutes.post("/alerts", requireSuperAdmin, async (req: Request, res: Response) => {
...
alertRoutes.patch("/alerts/:id", requireSuperAdmin, async (req: Request<{ id: string }>, res: Response) => {
...
alertRoutes.delete("/alerts/:id", requireSuperAdmin, (req: Request<{ id: string }>, res: Response) => {
  const id = Number(req.params.id);
...
alertRoutes.post("/alerts/:id/test", requireSuperAdmin, async (req: Request<{ id: string }>, res: Response) => {
  const id = Number(req.params.id);
  if (!getAlertRule(id)) {
    notFound(res, "ALERT_NOT_FOUND", "Alert rule not found");
    return;
