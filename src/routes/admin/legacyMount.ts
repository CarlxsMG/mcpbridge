...
export function mountLegacy(parent: Router): void {
  ...
  parent.get("/users", requireAdminRole, (_req: Request, res: Response) => {
  ...
  parent.post("/users", requireAdminRole, async (req: Request, res: Response) => {
    const body = (req.body as Record<string, unknown>) ?? {};
  ...
  parent.get("/audit-log", (req: Request, res: Response) => {
  ...
  parent.get("/audit-log/verify", (_req: Request, res: Response) => {
  ...
  parent.get("/audit-log/actions", (_req: Request, res: Response) => {
    res.status(200).json({ actions: listAuditActions() });
  });

  parent.get("/audit-log/export", (req: Request, res: Response) => {
