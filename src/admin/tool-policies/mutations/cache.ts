 ...
 */
import { setToolCacheConfig, getToolCacheConfig } from "../../../tool-policies/response-cache.js";
...
export const cacheMutation: ToolMutation = {
  ...
  read: (clientName, toolName) => getToolCacheConfig(clientName, toolName) ?? undefined,
  audit: (_raw, parsed) => {
